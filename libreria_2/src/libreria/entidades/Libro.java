...
@NamedQueries({
    @NamedQuery(name="Libro.buscarPorTitulo", query="SELECT l FROM Libro l WHERE l.titulo = :titulo"),
    @NamedQuery(name="Libro.buscarPorNombreAutor", query="SELECT l FROM Libro l WHERE l.autor.nombre = :nombre"),
    @NamedQuery(name="Libro.buscarPorNombreEditorial", query="SELECT l FROM Libro l WHERE l.editorial.nombre = :nombre")
})
@Entity
